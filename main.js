...
const defineThirdWorld = () => {
    const cupcakeWorld = new Scene(GlobalConfig.THIRD_SCENE_NAME, true);
    /*
     * TODO TASK
     *  For each level, we need to define the assets (images and sounds) available in the scene.
     *  You can try switching assets by changing the urls, butg make sure to not change the ids! :)
     */
    cupcakeWorld.imageManager.addBackground('images/london.jpg');
    cupcakeWorld.imageManager.addImage('tile_left', 'images/tile_moon_left.png');
    cupcakeWorld.imageManager.addImage('tile_mid', 'images/tile_moon_mid.png');
    cupcakeWorld.imageManager.addImage('tile_right', 'images/tile_moon_right.png');
    cupcakeWorld.imageManager.addImage('cupcake', 'images/tt.png');
    cupcakeWorld.imageManager.addImage('player_default', 'images/ddb.png');
    cupcakeWorld.imageManager.addImage('player_hurt', 'images/ddb.png');
    cupcakeWorld.imageManager.addImage('player_jump', 'images/ddb.png');
    cupcakeWorld.imageManager.addImage('player_walk_1', 'images/ddb.png');
    cupcakeWorld.imageManager.addImage('player_walk_2', 'images/ddb.png');
    cupcakeWorld.imageManager.addImage('player_walk_3', 'images/ddb.png');
    cupcakeWorld.soundManager.addSfx('drop', 'sound/drop.mp3');
    cupcakeWorld.soundManager.addSfx('eat', 'sound/yay.mp3');
    cupcakeWorld.createEntities = () => {
        for (let i = 0; i <= 9; i++) {
            const tileType = i === 0 ? TileType.LEFT :
                i === 9 ? TileType.RIGHT :
